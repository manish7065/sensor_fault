...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            # Valid train and test data frame
            ...
            if not model_resolver.is_model_exists():
                model_evaluation_artifact = ModelEvaluationArtifact(
                    ...
                    trianed_model_path = train_model_file_path, 
                    train_model_metric_artifact = self.model_trainer_artifact.test_metric_artifact, 
                    test_model_metric_artifact = None)
            ...
            model_evaluation_artifact = ModelEvaluationArtifact(
                ...
                best_model_path = None, 
                trianed_model_path = None, 
                train_model_metric_artifact = train_model_file_path, 
                test_model_metric_artifact = latest_metric)
            ...
            raise SensorException(e,sys)
            # logging.info(SensorException(e, sys))